...
<?php if ($objMembershipService->hasPermission('admin', $member->group_id)) : ?>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo base_url('user/admin/dashboard/blogs/') ?>"><i class="fa fa-circle-o"></i> blogs </a></li>
        </ul>
    </li>
...
<?php else: ?>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="<?php echo base_url('user/member/dashboard/blogs/')  ?>"><i class="fa fa-circle-o"></i> Blogs</a></li>
            <li><a href="<?php echo base_url('user/member/dashboard/blogs/create.php')  ?>"><i class="fa fa-circle-o"></i> Create </a></li>
        </ul>
    </li>
