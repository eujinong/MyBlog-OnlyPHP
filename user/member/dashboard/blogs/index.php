    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <ul class="list-inline">
                <li><a href="<?php echo base_url("user/member/dashboard/blogs/create.php") ?>"><button class="btn btn-success"><i class="fa fa-plus"></i> &nbsp New Blog</button></a></li>
            </ul>
                            ...
                            <table id="data_table" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            <a class="btn btn-primary btn-sm" href="<?php echo base_url("user/member/dashboard/blogs/edit.php?id=".$single_blog->id) ?>"><i class="fa fa-pencil-square-o"></i></a>

                                            <form style="display: inline-block" action="<?php echo base_url("user/member/dashboard/blogs/delete.php?id=".$single_blog->id) ?>" method="POST">
