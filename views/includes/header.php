                ...
                <div class="col m8">
                    <ul class="main_nav">
                        ...
                        if ($objMembershipService->isLoggedIn()) : ?>
                            <li><a href="<?php echo base_url('user/member/dashboard/blogs/create.php') ?>">Write Your Blog</a></li>
                        <?php endif; ?>
                    ...
                    <div class="featured">
                        <div class="outer">
                            <div class="blog">
                                ...
                                <a href="#" class="waves-effect waves-light btn">READ FULL BLOG</a>
                            </div>
                        </div>
                    </div>
                </div>
